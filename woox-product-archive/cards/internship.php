...
foreach($products as $product) {
    ...
    $scholarship_percentage = get_post_meta( $product->get_id(), 'job_type', true );
    ...
    <div class="archive-card">
        <div class="imagewrap">
            ...
            <span class="role"><?php echo $employment_status; ?></span>
        </div>
        <div class="title-wrap">
            <h3><a href="<?php echo $product->get_permalink(); ?>"><?php echo $product->get_title(); ?></a></h3>
            <div class="price"><?php echo '$'.$product->get_price(); ?>/<span>weekly</span></div>
        </div>
        <div class="metawrap">
